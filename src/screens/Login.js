...
//       const userInfom = await GoogleSignin.signIn();
//       console.log('user info', userInfom);
...
//       <TouchableOpacity style={styles.Socibtn} onPress={signIn}>
//         <Google />
...
const Login = () => {
  ...
  return (
    <ScrollView style={{flex: 1, backgroundColor: 'rgb(229, 243, 253)'}}>
      ...
      {/* Render Google button on both platforms */}
      <TouchableOpacity style={styles.Socibtn} onPress={signIn}>
        <Google />
        <Text style={styles.socialtxt}>Sign up with Google</Text>
      </TouchableOpacity>
